    ...
    <div class="mint-loadmore-content" :class="{ 'is-dropped': topDropped || bottomDropped}" :style="{ 'transform': 'translate3d(0, ' + translate + 'px, 0)' }" v-el:loadmore-content>
      <slot name="top">
        <div class="mint-loadmore-top" v-if="topMethod">
          <div v-if="topStatus === 'loading'" class="mint-loadmore-spinner" :size="20" type="fading-circle"></div>
      ...
      <slot name="bottom">
        <div class="mint-loadmore-bottom" v-if="bottomMethod">
          <div v-if="bottomStatus === 'loading'" class="mint-loadmore-spinner" :size="20" type="fading-circle"></div>
